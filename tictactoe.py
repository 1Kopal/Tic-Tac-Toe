...
class Board(object):
    """
    A Tic-Tac-Toe board that knows how to play.
    """
    ...
    def computer_move(self):
        # Tactical choices, in descending order of preference, are:
        # Win...
        ...
        # ...or, failing all else, randomly choose a move.
        else:
            x, y = random.choice(self.possible_moves())
        # Move has been decided, so make it.
